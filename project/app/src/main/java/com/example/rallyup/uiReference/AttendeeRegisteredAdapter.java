 ...
 */
public class AttendeeRegisteredAdapter extends BaseAdapter {
     ...
     */
    public AttendeeRegisteredAdapter(Context context, List<Registration> userList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Registration user = userList.get(position);
